...
- [x] APIエンドポイント実装
  ...
  - [x] POST `/clips/search` - クリップ内ノート検索
...
- [x] APIエンドポイント実装
  ...
  - [x] POST `/channels/timeline` - チャンネルタイムライン
- [x] マイグレーション作成
- [x] ノートのチャンネル投稿対応（channel_idフィールド追加）
- [ ] チャンネルタイムラインのストリーミング
- [ ] **[拡張]** チャンネルカテゴリ/タグ
- [ ] **[拡張]** チャンネルモデレーター機能
- [ ] **[拡張]** チャンネル内ミュート/ブロック
...
|-------|------|------|
| 高 | GraphQL API | 未着手 |
| 高 | Webhook配信ワーカー | 部分実装 |
| 中 | 高度な検索（全文検索エンジン） | 未着手 |
| 中 | AI/LLM 統合 | 未着手 |
| 低 | プラグインシステム | 未着手 |
| 低 | 分析・統計ダッシュボード | 未着手 |
